...
export default function Navbar() {
  ...
  return (
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="hidden sm:block text-[10px] font-bold tracking-[0.2em] text-gray-400 uppercase mt-0.5">
                Premium Touch
              </span>
            </div>
          </NavLink>
    ...
    "
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`md:hidden absolute w-full bg-white border-b shadow-lg transition-all duration-300 overflow-hidden ${
