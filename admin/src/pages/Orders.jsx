...
const Orders = ({ token }) => {
  ...
  const orderedItemStatusHandler = async (event, orderId) => {
    try {
      const response = await axios.post(
        backend_url + "/api/order/updateOrderStatus",
                ...
                <div className="grid lg:grid-cols-[80px_1.5fr_1fr_0.7fr_0.8fr] gap-6 items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 leading-6">
                      ...
                      <p>
                        {orderitem.address.city}, {orderitem.address.state}
                      </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p>
                        ...
                        >
                          {orderitem.payment ? "Paid" : "Pending"}
                        </span>
                      </p>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <select
                    onChange={(event)=>orderedItemStatusHandler(event,orderitem._id)}
